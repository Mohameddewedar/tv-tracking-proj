...
int main(int argc, char **argv)
{
    ...
    VideoWriter video("../videos/raspi_out.avi", CV_FOURCC('M', 'J', 'P', 'G'), 25, Size(frame_width, frame_height));
    ...
    while (cap.read(frame))
    {
        ...
        if (ok)
        {
            ...
            tgt_center_normalized.x = (tgt_center.x - frame_width / 2) / (frame_width / 2);
            tgt_center_normalized.y = (tgt_center.y - frame_height / 2) / (frame_height / 2);
